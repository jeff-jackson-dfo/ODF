...
A few years ago the data group at BIO decided to start all new script development using the [R](https://cran.r-project.org/) language within [RStudio](https://rstudio.com/)<sup>&reg;</sup> and the [Python](https://www.python.org/) language, primarily using the [Anaconda](https://www.anaconda.com/)<sup>&reg;</sup> development ecosystem. 
